...
$(document).ready(function () {
    ...
    // Opciones posibles según el número de estrellas (0 a 5)
    ...
    $('.ratable').on('starrr:change', function (e, value) {
        ...
        // Div .indicators que contiene al formulario (botón de enviar)
        var target = $(this).closest('.evaluation').children('.indicators');
        // Actualiza el campo puntuación del formulario y muestra el mismo.
